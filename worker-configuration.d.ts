/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 86ffff5dab5accdf68a329b9d2c4193c)
// Runtime types generated with workerd@1.20260617.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	INGEST_TOKEN: string;
	REPAIR_SIGNING_KEY: string;
	ForensicCaseAgent: DurableObjectNamespace<import("./src/index").ForensicCaseAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ForensicCaseAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INGEST_TOKEN" | "REPAIR_SIGNING_KEY">> {}
}
